<template>
  <div class="full-size-block flex-container content-center column">
    ...
    <Form class="line" :on-submit="onSubmit">
      <div slot="content">
        <div class="line">
          <h2 class="text--bright">Регистрация</h2>
        </div>
        <LoginInput />
        <EmailInput />
        <PasswordInput />
    ...
    <p>Зарегистрированы? <nuxt-link to="/login">Войти</nuxt-link></p>
...
import EmailInput from "../../components/Pages/Login/Inputs/EmailInput/EmailInput";
...
export default {
  name: "Login",
  components: { Loader, LoginErrors, PasswordInput, EmailInput, LoginInput, Input, Form },
  methods: {
    onSubmit(values) {
